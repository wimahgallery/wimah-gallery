...
function PricingCards({ openId, setOpenId, isInView }: { openId: string | null; setOpenId: (id: string | null) => void; isInView: boolean }) {
  return (
...
function PricingMobile() {
  ...
  return (
    <section ref={sectionRef} id="pricing" className="relative py-32 overflow-hidden">
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] -translate-y-1/2 rounded-full bg-accent/5 blur-[80px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
        ...
        <PricingCards openId={openId} setOpenId={setOpenId} isInView={isInView} />
      </div>
    </section>
  );
}
