...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="#home" className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-3xl bg-accent/10 border border-accent/20">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden md:flex items-center justify-center text-text-secondary hover:text-accent transition-colors duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden md:flex items-center gap-2 bg-accent hover:bg-accent-light text-background font-semibold rounded-full px-6 py-2.5 transition-all duration-300 hover:shadow-[0_4px_24px_rgba(191,67,66,0.3)]"
              >
      ...
      <div
        className={`fixed inset-0 z-40 bg-background/95 lg:hidden transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          mobileOpen
      ...
      >
        <nav className="flex flex-col items-center justify-center h-full gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 flex items-center gap-2 bg-accent hover:bg-accent-light text-background font-semibold rounded-full px-8 py-4 text-base transition-all duration-500"
            style={{
