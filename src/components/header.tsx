          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-2">
              {navItems.map((item) => (
                <a
                  key={item.href}
                  href={item.href}
                  className="relative px-4 py-2 text-sm font-medium text-text-secondary transition-colors duration-200 hover:text-text-primary group"
                >
                  {item.label}
                  <span className="absolute bottom-0 left-1/2 h-px w-0 bg-accent transition-all duration-200 group-hover:left-4 group-hover:w-[calc(100%-2rem)]" />
                </a>
              ))}
            </nav>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="hidden md:flex h-10 w-10 items-center justify-center rounded-3xl border border-border text-text-secondary transition-colors duration-200 hover:border-accent/30 hover:text-accent"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden md:flex items-center gap-2 rounded-3xl bg-accent px-6 py-3 text-sm font-semibold text-background transition-all duration-200 hover:bg-accent-light hover:shadow-[0_4px_24px_rgba(191,67,66,0.3)]"
              >
              ...
              <button
                ...
                className="flex lg:hidden h-10 w-10 items-center justify-center rounded-3xl border border-border text-text-secondary transition-colors duration-200 hover:border-accent/30 hover:text-accent"
            ...
            <nav className="flex flex-col items-center justify-center h-full gap-8">
              {navItems.map((item, i) => (
                <motion.a
                  ...
                  className="text-2xl font-heading font-semibold text-text-primary transition-colors duration-200 hover:text-accent"
                >
                  {item.label}
                </motion.a>
              ))}
              ...
              <div className="flex items-center gap-4 mt-4">
                <a href={siteConfig.instagram} target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent transition-colors duration-200" aria-label="Instagram">
                ...
                <a href={siteConfig.tiktok} target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent transition-colors duration-200" aria-label="TikTok">
                ...
                <a href={siteConfig.whatsappLink} target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-accent transition-colors duration-200" aria-label="WhatsApp">
