        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <a href="#home" className="flex items-center gap-3 group">
              <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-3xl border border-accent/20 transition-all duration-300 group-hover:border-accent/30 group-hover:scale-105">
                <img src="/wimah.png" alt="Wimah Gallery" className="h-full w-full object-cover invert" />
              </div>
              <span className="font-heading text-base font-normal tracking-tight text-text-primary hidden sm:block transition-colors duration-300 group-hover:text-accent-light">
                {siteConfig.name}
              </span>
            </a>
      ...
      >
        {mobileOpen && (
          <nav className="flex flex-col items-center justify-center h-full gap-2">
              ...
              if (isCTA) {
                return (
                  <animated.a
                    ...
                    style={style}
                    className="mt-6 flex items-center gap-2 bg-background text-text-primary font-body font-semibold rounded-3xl px-8 py-4 text-base transition-all duration-300 hover:shadow-[0_4px_24px_rgba(245,243,238,0.2)] hover:scale-[1.02] active:scale-[0.98]"
                  >
            ...
            <animated.div
              style={trail[trail.length - 1] ? {
                opacity: trail[trail.length - 1].opacity,
                y: trail[trail.length - 1].y,
                scale: trail[trail.length - 1].scale,
              } : {}}
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center h-11 w-11 rounded-3xl border border-white/20 text-white/80 transition-all duration-300 hover:text-background hover:border-background/40 hover:bg-white/[0.06]"
                aria-label="Instagram"
              >
