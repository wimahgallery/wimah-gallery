...
function TestimonialCard({
  ...
  return (
    <animated.div
      ref={ref}
      style={cardSpring}
      className="rounded-3xl border border-border bg-surface/50 p-8 transition-[transform,colors] duration-300 hover:border-accent/30 hover:scale-[1.02] active:scale-[0.98] hover:shadow-[0_8px_32px_rgba(124,132,114,0.06)]"
    >
