    ...
    <section className="relative">
      <div ref={containerRef} className="h-[200vh]">
        <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
          ...
          <div className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent/6 blur-[150px]" />

          <div className="relative z-10 mx-auto max-w-[900px] px-6 lg:px-8 text-center">
            <p className="mb-6 text-sm font-medium tracking-wider uppercase text-accent">
              ...
              {italicWords.map((word, i) => {
                ...
                return (
                  <animated.span
                    key={i}
                    style={{ opacity: wordOpacity, y: wordY }}
                    className="inline-block font-elegant italic text-accent-light mr-[0.3em]"
                  >
                    {word}
                  </animated.span>
                )
