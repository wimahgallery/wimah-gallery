      ...
      <div className="mx-auto max-w-300 px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="max-w-sm text-xs sm:text-sm text-text-secondary leading-snug">
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              {siteConfig.navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-xs sm:text-sm text-text-secondary transition-colors duration-300 hover:text-accent hover:underline underline-offset-4 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-xs sm:text-sm text-text-secondary transition-colors duration-300 hover:text-accent hover:underline underline-offset-4 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
                >
