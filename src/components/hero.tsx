...
const cardData = [
  { rotate: -8, x: -60, y: -20, h: 280, w: 200, src: "https://images.unsplash.com/photo-1519741497674-611481863552?w=400&h=560&fit=crop" },
  { rotate: 3, x: 40, y: -40, h: 320, w: 220, src: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=440&h=640&fit=crop" },
  { rotate: -2, x: -20, y: 20, h: 260, w: 190, src: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=380&h=520&fit=crop" },
  { rotate: 8, x: 80, y: 40, h: 240, w: 170, src: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=340&h=480&fit=crop" },
];

function HeroCard({ card, index }: { card: (typeof cardData)[number]; index: number }) {
  return (
    <motion.div
...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className={`relative ${isMobile ? "min-h-screen" : "min-h-[120vh]"} flex items-center overflow-hidden`}
    >
      ...
      {!isMobile && (
        <>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-heading text-[12vw] font-black text-text-primary/3 leading-none select-none pointer-events-none whitespace-nowrap tracking-tighter">
            KENANGAN
          </div>
        </>
      )}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <motion.h1
              ...
              className="font-heading text-[40px] sm:text-[56px] lg:text-[72px] font-bold leading-[1.05] tracking-tight"
            >
