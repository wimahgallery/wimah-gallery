      ...
      <div className="relative mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div ref={textRef} className="text-center lg:text-left">
            ...
            <p className="mb-8 max-w-[420px] text-sm sm:text-base text-text-secondary leading-relaxed mx-auto lg:mx-0">
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden py-2" ref={emblaRef}>
              <div className="flex gap-3 sm:gap-4">
                {images.map((img, i) => (
                  <div key={i} className="shrink-0 w-[200px] sm:w-[260px] lg:w-[300px]">
