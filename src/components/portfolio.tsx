    ...
    <section id="portfolio" className="relative py-20 lg:py-32 texture-dots">
      ...
      <div className="relative mb-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-6">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full border border-border bg-background/50 px-5 py-2.5 text-sm font-medium text-text-primary transition-all duration-300 hover:border-accent/30 hover:bg-accent/5 hover:scale-[1.02] active:scale-[0.98]"
        >
        ...
        <a
          href="#pricing"
          className="inline-flex items-center gap-2 rounded-full bg-accent text-background px-6 py-2.5 text-sm font-medium transition-all duration-300 hover:bg-accent-light hover:shadow-[0_4px_20px_rgba(124,132,114,0.25)] hover:scale-[1.02] active:scale-[0.98]"
        >
          Lihat Harga
        </a>
      </div>
      ...
      <div className="relative space-y-3 overflow-hidden">
        <div className="relative">
          <div className="absolute left-0 top-0 bottom-0 w-20 md:bg-gradient-to-r md:from-background to-transparent z-10" />
          <div className="absolute right-0 top-0 bottom-0 w-20 md:bg-gradient-to-l md:from-background to-transparent z-10" />
